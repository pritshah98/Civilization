...
public class TerrainTileFX extends StackPane {
    ...
    public void updateTileView() {
        ...
        if (!(this.getTile().isEmpty())) {
            this.overlay.setFill(this.getTile().getOccupant().getColor());
            icon = new ImageView(this.getTile().getOccupant().getImage());
        ...
        if (GameController.getLastClicked() != null
            ...
            GameController.getLastClicked().overlay
